...
// Todo - pastBranches establishes past order,
//  branchList establishes validity and provides detail info
func GetBranchesInfo() (validPastBranches []brops.BranchListItem, currBranch string, err error) {
	...
	brList := make([]brops.BranchListItem, 0, 32)           // len and capacity specified
